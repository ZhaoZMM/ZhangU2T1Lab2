public class ChatBot {
    ...
    //method that prints an invitation
    public void invitation(){
        System.out.println("Hey,"+name+" you should come in, the weather here is nice!");
    }

    //method that multiplies numbers

    public int multNumbers(int num4, int num5, int num6){
